...
public class NoriTokenizerFactory extends AbstractTokenizerFactory {
    ...
    private final List<String> karrotOption;
    ...
    public NoriTokenizerFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
        ...
        karrotOption = getKarrotOption(settings);
        searchMode = settings.getAsBoolean("search_mode", true);
    }
    ...
    public static List<String> getKarrotOption(Settings settings) {
        List<String> karrotOption = settings.getAsList("karrot_option", new ArrayList<String>());
        return karrotOption;
    }

    public static boolean getSearchMode(Settings settings) {
        return settings.getAsBoolean("search_mode", true);
    }
